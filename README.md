	...
	<ul>
		...
		<li><a href= "https://docs.google.com/document/d/1snROtUFb4DGpGE0kVZr6nFM1GUnRuaXFwLWCYvFM3ME/edit?usp=sharing">Language(English)(letter)</a></li>            
		 ...
		 <li><a href= "">Anthropology(humanity)</a></li> 
		  ...
		  <li><a href="#">Social computing and human–computer interaction(how people interact with technology.)</a></li>
...
- [X] [States of Matter](https://en.wikipedia.org/wiki/State_of_matter)
	...
	- [X] [Fermionic Matter]()
	- [X] [Super Conductivity]()
	- [X] [Superfluid]()
	- [X] [Supersolid]()
	- [X] [Quantum-Spin Liquid]()
	- [X] [Fermion Materials]()
	- [X] [Rydberg Polaron]()
...
<summary>Quantum computing(Quantum information processing + Algorithms) </summary>
...
<summary>Social computing and human–computer interaction(Design + display design+current research)</summary>
...
* [Chapter 2: Symmetric Encryption(secret key shared by sender and receiver)](https://github.com/madanbaduwal/masters/blob/main/Semester%201/Computer%20And%20Network%20Security/T2-SymmetricEncryption.pdf)
	...
	- [X] [Basis Terminology]()
		...
		- Cipher: algorithm for transforming plaintext to ciphertext(Strength of cipher is dependent on the size of key not the size of input)
    ...
    - [X] [Cryptoanalysis]()
        ...
        generated by the scheme meets one or both of the following
        criteria:
	...
	- [X] [Feistel Cipher](https://en.wikipedia.org/wiki/Feistel_cipher) : The Feistel cipher is a **design model or structure used to build various symmetric block ciphers, such as DES**. This design model can have invertible, non-invertible, and self-invertible components. Additionally, the Feistel block cipher uses the same encryption and decryption algorithms.  

	- [X] [Block Cipher](https://www.tutorialspoint.com/cryptography/block_cipher.htm): A block cipher takes a block of plaintext bits and generates a block of ciphertext bits, generally of same size. The size of block is fixed in the given scheme. The choice of block size does not directly affect to the strength of encryption scheme. The strength of cipher depends up on the key length.
	    - The most commonly used
          symmetric encryption algorithms
        - Processes the plaintext input in
        fixed-sized blocks and produces
        a block of ciphertext of equal
        size for each plaintext block

	- [X] [Symmetric Block Encryption Algorithms](https://www.cryptomathic.com/news-events/blog/symmetric-key-encryption-why-where-and-how-its-used-in-banking)
		...
		- [X] [Advanced Encryption Standard (AES): geeksforgeeks](https://www.geeksforgeeks.org/advanced-encryption-standard-aes/)
...
- [X] [How to apply to abroad universities](https://github.com/madanbaduwal/usa-university-application-process)
...
## Build Resume
- [X] [PIRATE KING](https://drive.google.com/drive/folders/1QOuT9FV2vLtnHP96Fk2aYU-RJMI8EOQW)
- [X] []()
...
- [ ] [AWS: Documentation](https://docs.aws.amazon.com/)
	...
	- [X] [AWS lambda](https://docs.aws.amazon.com/lambda/index.html)
	- [Z] [IAM](https://docs.aws.amazon.com/iam/index.html)
- [X] [Serverless vs Containers](https://www.cloudflare.com/learning/serverless/serverless-vs-containers/)
- [ ] [Azure]()
- [ ] [Heoraku]()
